import{A as Re,B as Pa,I as Ua,K as Ma,R as Pe,U as Da,a as _t,f as Ra,x as he,y as ge}from"./IPAGS25B.js";import{a as Be}from"./3JX3VARJ.js";import{c as ka,f as z}from"./PQ35KENF.js";var no=ka((ga,ya)=>{(function(e,t){typeof ga=="object"&&typeof ya<"u"?ya.exports=t():typeof define=="function"&&define.amd?define(t):(e=typeof globalThis<"u"?globalThis:e||self).dayjs=t()})(ga,function(){"use strict";var e=1e3,t=6e4,a=36e5,r="millisecond",o="second",n="minute",i="hour",s="day",l="week",p="month",f="quarter",h="year",g="date",m="Invalid Date",S=/^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/,R=/\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g,C={name:"en",weekdays:"Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),months:"January_February_March_April_May_June_July_August_September_October_November_December".split("_"),ordinal:function(y){var c=["th","st","nd","rd"],u=y%100;return"["+y+(c[(u-20)%10]||c[u]||c[0])+"]"}},E=function(y,c,u){var b=String(y);return!b||b.length>=c?y:""+Array(c+1-b.length).join(u)+y},$={s:E,z:function(y){var c=-y.utcOffset(),u=Math.abs(c),b=Math.floor(u/60),d=u%60;return(c<=0?"+":"-")+E(b,2,"0")+":"+E(d,2,"0")},m:function y(c,u){if(c.date()<u.date())return-y(u,c);var b=12*(u.year()-c.year())+(u.month()-c.month()),d=c.clone().add(b,p),_=u-d<0,T=c.clone().add(b+(_?-1:1),p);return+(-(b+(u-d)/(_?d-T:T-d))||0)},a:function(y){return y<0?Math.ceil(y)||0:Math.floor(y)},p:function(y){return{M:p,y:h,w:l,d:s,D:g,h:i,m:n,s:o,ms:r,Q:f}[y]||String(y||"").toLowerCase().replace(/s$/,"")},u:function(y){return y===void 0}},F="en",W={};W[F]=C;var j=function(y){return y instanceof ke},v=function y(c,u,b){var d;if(!c)return F;if(typeof c=="string"){var _=c.toLowerCase();W[_]&&(d=_),u&&(W[_]=u,d=_);var T=c.split("-");if(!d&&T.length>1)return y(T[0])}else{var O=c.name;W[O]=c,d=O}return!b&&d&&(F=d),d||!b&&F},A=function(y,c){if(j(y))return y.clone();var u=typeof c=="object"?c:{};return u.date=y,u.args=arguments,new ke(u)},w=$;w.l=v,w.i=j,w.w=function(y,c){return A(y,{locale:c.$L,utc:c.$u,x:c.$x,$offset:c.$offset})};var ke=function(){function y(u){this.$L=v(u.locale,null,!0),this.parse(u)}var c=y.prototype;return c.parse=function(u){this.$d=function(b){var d=b.date,_=b.utc;if(d===null)return new Date(NaN);if(w.u(d))return new Date;if(d instanceof Date)return new Date(d);if(typeof d=="string"&&!/Z$/i.test(d)){var T=d.match(S);if(T){var O=T[2]-1||0,L=(T[7]||"0").substring(0,3);return _?new Date(Date.UTC(T[1],O,T[3]||1,T[4]||0,T[5]||0,T[6]||0,L)):new Date(T[1],O,T[3]||1,T[4]||0,T[5]||0,T[6]||0,L)}}return new Date(d)}(u),this.$x=u.x||{},this.init()},c.init=function(){var u=this.$d;this.$y=u.getFullYear(),this.$M=u.getMonth(),this.$D=u.getDate(),this.$W=u.getDay(),this.$H=u.getHours(),this.$m=u.getMinutes(),this.$s=u.getSeconds(),this.$ms=u.getMilliseconds()},c.$utils=function(){return w},c.isValid=function(){return this.$d.toString()!==m},c.isSame=function(u,b){var d=A(u);return this.startOf(b)<=d&&d<=this.endOf(b)},c.isAfter=function(u,b){return A(u)<this.startOf(b)},c.isBefore=function(u,b){return this.endOf(b)<A(u)},c.$g=function(u,b,d){return w.u(u)?this[b]:this.set(d,u)},c.unix=function(){return Math.floor(this.valueOf()/1e3)},c.valueOf=function(){return this.$d.getTime()},c.startOf=function(u,b){var d=this,_=!!w.u(b)||b,T=w.p(u),O=function(Le,H){var me=w.w(d.$u?Date.UTC(d.$y,H,Le):new Date(d.$y,H,Le),d);return _?me:me.endOf(s)},L=function(Le,H){return w.w(d.toDate()[Le].apply(d.toDate("s"),(_?[0,0,0,0]:[23,59,59,999]).slice(H)),d)},U=this.$W,Y=this.$M,ce=this.$D,pe="set"+(this.$u?"UTC":"");switch(T){case h:return _?O(1,0):O(31,11);case p:return _?O(1,Y):O(0,Y+1);case l:var st=this.$locale().weekStart||0,lt=(U<st?U+7:U)-st;return O(_?ce-lt:ce+(6-lt),Y);case s:case g:return L(pe+"Hours",0);case i:return L(pe+"Minutes",1);case n:return L(pe+"Seconds",2);case o:return L(pe+"Milliseconds",3);default:return this.clone()}},c.endOf=function(u){return this.startOf(u,!1)},c.$set=function(u,b){var d,_=w.p(u),T="set"+(this.$u?"UTC":""),O=(d={},d[s]=T+"Date",d[g]=T+"Date",d[p]=T+"Month",d[h]=T+"FullYear",d[i]=T+"Hours",d[n]=T+"Minutes",d[o]=T+"Seconds",d[r]=T+"Milliseconds",d)[_],L=_===s?this.$D+(b-this.$W):b;if(_===p||_===h){var U=this.clone().set(g,1);U.$d[O](L),U.init(),this.$d=U.set(g,Math.min(this.$D,U.daysInMonth())).$d}else O&&this.$d[O](L);return this.init(),this},c.set=function(u,b){return this.clone().$set(u,b)},c.get=function(u){return this[w.p(u)]()},c.add=function(u,b){var d,_=this;u=Number(u);var T=w.p(b),O=function(Y){var ce=A(_);return w.w(ce.date(ce.date()+Math.round(Y*u)),_)};if(T===p)return this.set(p,this.$M+u);if(T===h)return this.set(h,this.$y+u);if(T===s)return O(1);if(T===l)return O(7);var L=(d={},d[n]=t,d[i]=a,d[o]=e,d)[T]||1,U=this.$d.getTime()+u*L;return w.w(U,this)},c.subtract=function(u,b){return this.add(-1*u,b)},c.format=function(u){var b=this,d=this.$locale();if(!this.isValid())return d.invalidDate||m;var _=u||"YYYY-MM-DDTHH:mm:ssZ",T=w.z(this),O=this.$H,L=this.$m,U=this.$M,Y=d.weekdays,ce=d.months,pe=function(H,me,pa,xt){return H&&(H[me]||H(b,_))||pa[me].slice(0,xt)},st=function(H){return w.s(O%12||12,H,"0")},lt=d.meridiem||function(H,me,pa){var xt=H<12?"AM":"PM";return pa?xt.toLowerCase():xt},Le={YY:String(this.$y).slice(-2),YYYY:this.$y,M:U+1,MM:w.s(U+1,2,"0"),MMM:pe(d.monthsShort,U,ce,3),MMMM:pe(ce,U),D:this.$D,DD:w.s(this.$D,2,"0"),d:String(this.$W),dd:pe(d.weekdaysMin,this.$W,Y,2),ddd:pe(d.weekdaysShort,this.$W,Y,3),dddd:Y[this.$W],H:String(O),HH:w.s(O,2,"0"),h:st(1),hh:st(2),a:lt(O,L,!0),A:lt(O,L,!1),m:String(L),mm:w.s(L,2,"0"),s:String(this.$s),ss:w.s(this.$s,2,"0"),SSS:w.s(this.$ms,3,"0"),Z:T};return _.replace(R,function(H,me){return me||Le[H]||T.replace(":","")})},c.utcOffset=function(){return 15*-Math.round(this.$d.getTimezoneOffset()/15)},c.diff=function(u,b,d){var _,T=w.p(b),O=A(u),L=(O.utcOffset()-this.utcOffset())*t,U=this-O,Y=w.m(this,O);return Y=(_={},_[h]=Y/12,_[p]=Y,_[f]=Y/3,_[l]=(U-L)/6048e5,_[s]=(U-L)/864e5,_[i]=U/a,_[n]=U/t,_[o]=U/e,_)[T]||U,d?Y:w.a(Y)},c.daysInMonth=function(){return this.endOf(p).$D},c.$locale=function(){return W[this.$L]},c.locale=function(u,b){if(!u)return this.$L;var d=this.clone(),_=v(u,b,!0);return _&&(d.$L=_),d},c.clone=function(){return w.w(this.$d,this)},c.toDate=function(){return new Date(this.valueOf())},c.toJSON=function(){return this.isValid()?this.toISOString():null},c.toISOString=function(){return this.$d.toISOString()},c.toString=function(){return this.$d.toUTCString()},y}(),Na=ke.prototype;return A.prototype=Na,[["$ms",r],["$s",o],["$m",n],["$H",i],["$W",s],["$M",p],["$y",h],["$D",g]].forEach(function(y){Na[y[1]]=function(c){return this.$g(c,y[0],y[1])}}),A.extend=function(y,c){return y.$i||(y(c,ke,A),y.$i=!0),A},A.locale=v,A.isDayjs=j,A.unix=function(y){return A(1e3*y)},A.en=W[F],A.Ls=W,A.p={},A})});var io=ka((ba,Ta)=>{(function(e,t){typeof ba=="object"&&typeof Ta<"u"?Ta.exports=t():typeof define=="function"&&define.amd?define(t):(e=typeof globalThis<"u"?globalThis:e||self).dayjs_plugin_utc=t()})(ba,function(){"use strict";var e="minute",t=/[+-]\d\d(?::?\d\d)?/g,a=/([+-]|\d\d)/g;return function(r,o,n){var i=o.prototype;n.utc=function(m){var S={date:m,utc:!0,args:arguments};return new o(S)},i.utc=function(m){var S=n(this.toDate(),{locale:this.$L,utc:!0});return m?S.add(this.utcOffset(),e):S},i.local=function(){return n(this.toDate(),{locale:this.$L,utc:!1})};var s=i.parse;i.parse=function(m){m.utc&&(this.$u=!0),this.$utils().u(m.$offset)||(this.$offset=m.$offset),s.call(this,m)};var l=i.init;i.init=function(){if(this.$u){var m=this.$d;this.$y=m.getUTCFullYear(),this.$M=m.getUTCMonth(),this.$D=m.getUTCDate(),this.$W=m.getUTCDay(),this.$H=m.getUTCHours(),this.$m=m.getUTCMinutes(),this.$s=m.getUTCSeconds(),this.$ms=m.getUTCMilliseconds()}else l.call(this)};var p=i.utcOffset;i.utcOffset=function(m,S){var R=this.$utils().u;if(R(m))return this.$u?0:R(this.$offset)?p.call(this):this.$offset;if(typeof m=="string"&&(m=function(F){F===void 0&&(F="");var W=F.match(t);if(!W)return null;var j=(""+W[0]).match(a)||["-",0,0],v=j[0],A=60*+j[1]+ +j[2];return A===0?0:v==="+"?A:-A}(m),m===null))return this;var C=Math.abs(m)<=16?60*m:m,E=this;if(S)return E.$offset=C,E.$u=m===0,E;if(m!==0){var $=this.$u?this.toDate().getTimezoneOffset():-1*this.utcOffset();(E=this.local().add(C+$,e)).$offset=C,E.$x.$localOffset=$}else E=this.utc();return E};var f=i.format;i.format=function(m){var S=m||(this.$u?"YYYY-MM-DDTHH:mm:ss[Z]":"");return f.call(this,S)},i.valueOf=function(){var m=this.$utils().u(this.$offset)?0:this.$offset+(this.$x.$localOffset||this.$d.getTimezoneOffset());return this.$d.valueOf()-6e4*m},i.isUTC=function(){return!!this.$u},i.toISOString=function(){return this.toDate().toISOString()},i.toString=function(){return this.toDate().toUTCString()};var h=i.toDate;i.toDate=function(m){return m==="s"&&this.$offset?n(this.format("YYYY-MM-DD HH:mm:ss:SSS")).toDate():h.call(this)};var g=i.diff;i.diff=function(m,S,R){if(m&&this.$u===m.$u)return g.call(this,m,S,R);var C=this.local(),E=n(m).local();return g.call(C,E,S,R)}}})});var li=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),ua={randomUUID:li};var Et,pi=new Uint8Array(16);function da(){if(!Et&&(Et=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!Et))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return Et(pi)}var G=[];for(let e=0;e<256;++e)G.push((e+256).toString(16).slice(1));function La(e,t=0){return(G[e[t+0]]+G[e[t+1]]+G[e[t+2]]+G[e[t+3]]+"-"+G[e[t+4]]+G[e[t+5]]+"-"+G[e[t+6]]+G[e[t+7]]+"-"+G[e[t+8]]+G[e[t+9]]+"-"+G[e[t+10]]+G[e[t+11]]+G[e[t+12]]+G[e[t+13]]+G[e[t+14]]+G[e[t+15]]).toLowerCase()}function ui(e,t,a){if(ua.randomUUID&&!t&&!e)return ua.randomUUID();e=e||{};let r=e.random||(e.rng||da)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,t){a=a||0;for(let o=0;o<16;++o)t[a+o]=r[o];return t}return La(r)}var fa=ui;function di(){this.__data__=[],this.size=0}var Ba=di;function fi(e,t){return e===t||e!==e&&t!==t}var oe=fi;function ci(e,t){for(var a=e.length;a--;)if(oe(e[a][0],t))return a;return-1}var ye=ci;var mi=Array.prototype,hi=mi.splice;function gi(e){var t=this.__data__,a=ye(t,e);if(a<0)return!1;var r=t.length-1;return a==r?t.pop():hi.call(t,a,1),--this.size,!0}var Wa=gi;function yi(e){var t=this.__data__,a=ye(t,e);return a<0?void 0:t[a][1]}var Ga=yi;function bi(e){return ye(this.__data__,e)>-1}var Ka=bi;function Ti(e,t){var a=this.__data__,r=ye(a,e);return r<0?(++this.size,a.push([e,t])):a[r][1]=t,this}var ja=Ti;function We(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var r=e[t];this.set(r[0],r[1])}}We.prototype.clear=Ba;We.prototype.delete=Wa;We.prototype.get=Ga;We.prototype.has=Ka;We.prototype.set=ja;var be=We;function xi(){this.__data__=new be,this.size=0}var Ya=xi;function _i(e){var t=this.__data__,a=t.delete(e);return this.size=t.size,a}var qa=_i;function Ei(e){return this.__data__.get(e)}var $a=Ei;function Si(e){return this.__data__.has(e)}var Fa=Si;var wi=typeof global=="object"&&global&&global.Object===Object&&global,St=wi;var Ai=typeof self=="object"&&self&&self.Object===Object&&self,Ii=St||Ai||Function("return this")(),M=Ii;var Ci=M.Symbol,B=Ci;var Ha=Object.prototype,Oi=Ha.hasOwnProperty,vi=Ha.toString,pt=B?B.toStringTag:void 0;function Ni(e){var t=Oi.call(e,pt),a=e[pt];try{e[pt]=void 0;var r=!0}catch{}var o=vi.call(e);return r&&(t?e[pt]=a:delete e[pt]),o}var Xa=Ni;var ki=Object.prototype,Ri=ki.toString;function Pi(e){return Ri.call(e)}var Va=Pi;var Ui="[object Null]",Mi="[object Undefined]",za=B?B.toStringTag:void 0;function Di(e){return e==null?e===void 0?Mi:Ui:za&&za in Object(e)?Xa(e):Va(e)}var K=Di;function Li(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}var I=Li;var Bi="[object AsyncFunction]",Wi="[object Function]",Gi="[object GeneratorFunction]",Ki="[object Proxy]";function ji(e){if(!I(e))return!1;var t=K(e);return t==Wi||t==Gi||t==Bi||t==Ki}var Ge=ji;var Yi=M["__core-js_shared__"],wt=Yi;var Ja=function(){var e=/[^.]+$/.exec(wt&&wt.keys&&wt.keys.IE_PROTO||"");return e?"Symbol(src)_1."+e:""}();function qi(e){return!!Ja&&Ja in e}var Za=qi;var $i=Function.prototype,Fi=$i.toString;function Hi(e){if(e!=null){try{return Fi.call(e)}catch{}try{return e+""}catch{}}return""}var ue=Hi;var Xi=/[\\^$.*+?()[\]{}|]/g,Vi=/^\[object .+?Constructor\]$/,zi=Function.prototype,Ji=Object.prototype,Zi=zi.toString,Qi=Ji.hasOwnProperty,es=RegExp("^"+Zi.call(Qi).replace(Xi,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function ts(e){if(!I(e)||Za(e))return!1;var t=Ge(e)?es:Vi;return t.test(ue(e))}var Qa=ts;function as(e,t){return e?.[t]}var er=as;function rs(e,t){var a=er(e,t);return Qa(a)?a:void 0}var X=rs;var os=X(M,"Map"),Te=os;var ns=X(Object,"create"),de=ns;function is(){this.__data__=de?de(null):{},this.size=0}var tr=is;function ss(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}var ar=ss;var ls="__lodash_hash_undefined__",ps=Object.prototype,us=ps.hasOwnProperty;function ds(e){var t=this.__data__;if(de){var a=t[e];return a===ls?void 0:a}return us.call(t,e)?t[e]:void 0}var rr=ds;var fs=Object.prototype,cs=fs.hasOwnProperty;function ms(e){var t=this.__data__;return de?t[e]!==void 0:cs.call(t,e)}var or=ms;var hs="__lodash_hash_undefined__";function gs(e,t){var a=this.__data__;return this.size+=this.has(e)?0:1,a[e]=de&&t===void 0?hs:t,this}var nr=gs;function Ke(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var r=e[t];this.set(r[0],r[1])}}Ke.prototype.clear=tr;Ke.prototype.delete=ar;Ke.prototype.get=rr;Ke.prototype.has=or;Ke.prototype.set=nr;var ca=Ke;function ys(){this.size=0,this.__data__={hash:new ca,map:new(Te||be),string:new ca}}var ir=ys;function bs(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}var sr=bs;function Ts(e,t){var a=e.__data__;return sr(t)?a[typeof t=="string"?"string":"hash"]:a.map}var xe=Ts;function xs(e){var t=xe(this,e).delete(e);return this.size-=t?1:0,t}var lr=xs;function _s(e){return xe(this,e).get(e)}var pr=_s;function Es(e){return xe(this,e).has(e)}var ur=Es;function Ss(e,t){var a=xe(this,e),r=a.size;return a.set(e,t),this.size+=a.size==r?0:1,this}var dr=Ss;function je(e){var t=-1,a=e==null?0:e.length;for(this.clear();++t<a;){var r=e[t];this.set(r[0],r[1])}}je.prototype.clear=ir;je.prototype.delete=lr;je.prototype.get=pr;je.prototype.has=ur;je.prototype.set=dr;var Ue=je;var ws=200;function As(e,t){var a=this.__data__;if(a instanceof be){var r=a.__data__;if(!Te||r.length<ws-1)return r.push([e,t]),this.size=++a.size,this;a=this.__data__=new Ue(r)}return a.set(e,t),this.size=a.size,this}var fr=As;function Ye(e){var t=this.__data__=new be(e);this.size=t.size}Ye.prototype.clear=Ya;Ye.prototype.delete=qa;Ye.prototype.get=$a;Ye.prototype.has=Fa;Ye.prototype.set=fr;var ne=Ye;function Is(e,t){for(var a=-1,r=e==null?0:e.length;++a<r&&t(e[a],a,e)!==!1;);return e}var At=Is;var Cs=function(){try{var e=X(Object,"defineProperty");return e({},"",{}),e}catch{}}(),qe=Cs;function Os(e,t,a){t=="__proto__"&&qe?qe(e,t,{configurable:!0,enumerable:!0,value:a,writable:!0}):e[t]=a}var _e=Os;var vs=Object.prototype,Ns=vs.hasOwnProperty;function ks(e,t,a){var r=e[t];(!(Ns.call(e,t)&&oe(r,a))||a===void 0&&!(t in e))&&_e(e,t,a)}var $e=ks;function Rs(e,t,a,r){var o=!a;a||(a={});for(var n=-1,i=t.length;++n<i;){var s=t[n],l=r?r(a[s],e[s],s,a,e):void 0;l===void 0&&(l=e[s]),o?_e(a,s,l):$e(a,s,l)}return a}var J=Rs;function Ps(e,t){for(var a=-1,r=Array(e);++a<e;)r[a]=t(a);return r}var cr=Ps;function Us(e){return e!=null&&typeof e=="object"}var P=Us;var Ms="[object Arguments]";function Ds(e){return P(e)&&K(e)==Ms}var ma=Ds;var mr=Object.prototype,Ls=mr.hasOwnProperty,Bs=mr.propertyIsEnumerable,Ws=ma(function(){return arguments}())?ma:function(e){return P(e)&&Ls.call(e,"callee")&&!Bs.call(e,"callee")},ee=Ws;var Gs=Array.isArray,x=Gs;function Ks(){return!1}var hr=Ks;var br=typeof exports=="object"&&exports&&!exports.nodeType&&exports,gr=br&&typeof module=="object"&&module&&!module.nodeType&&module,js=gr&&gr.exports===br,yr=js?M.Buffer:void 0,Ys=yr?yr.isBuffer:void 0,qs=Ys||hr,te=qs;var $s=9007199254740991,Fs=/^(?:0|[1-9]\d*)$/;function Hs(e,t){var a=typeof e;return t=t??$s,!!t&&(a=="number"||a!="symbol"&&Fs.test(e))&&e>-1&&e%1==0&&e<t}var Ee=Hs;var Xs=9007199254740991;function Vs(e){return typeof e=="number"&&e>-1&&e%1==0&&e<=Xs}var Fe=Vs;var zs="[object Arguments]",Js="[object Array]",Zs="[object Boolean]",Qs="[object Date]",el="[object Error]",tl="[object Function]",al="[object Map]",rl="[object Number]",ol="[object Object]",nl="[object RegExp]",il="[object Set]",sl="[object String]",ll="[object WeakMap]",pl="[object ArrayBuffer]",ul="[object DataView]",dl="[object Float32Array]",fl="[object Float64Array]",cl="[object Int8Array]",ml="[object Int16Array]",hl="[object Int32Array]",gl="[object Uint8Array]",yl="[object Uint8ClampedArray]",bl="[object Uint16Array]",Tl="[object Uint32Array]",k={};k[dl]=k[fl]=k[cl]=k[ml]=k[hl]=k[gl]=k[yl]=k[bl]=k[Tl]=!0;k[zs]=k[Js]=k[pl]=k[Zs]=k[ul]=k[Qs]=k[el]=k[tl]=k[al]=k[rl]=k[ol]=k[nl]=k[il]=k[sl]=k[ll]=!1;function xl(e){return P(e)&&Fe(e.length)&&!!k[K(e)]}var Tr=xl;function _l(e){return function(t){return e(t)}}var Se=_l;var xr=typeof exports=="object"&&exports&&!exports.nodeType&&exports,ut=xr&&typeof module=="object"&&module&&!module.nodeType&&module,El=ut&&ut.exports===xr,ha=El&&St.process,Sl=function(){try{var e=ut&&ut.require&&ut.require("util").types;return e||ha&&ha.binding&&ha.binding("util")}catch{}}(),fe=Sl;var _r=fe&&fe.isTypedArray,wl=_r?Se(_r):Tr,we=wl;var Al=Object.prototype,Il=Al.hasOwnProperty;function Cl(e,t){var a=x(e),r=!a&&ee(e),o=!a&&!r&&te(e),n=!a&&!r&&!o&&we(e),i=a||r||o||n,s=i?cr(e.length,String):[],l=s.length;for(var p in e)(t||Il.call(e,p))&&!(i&&(p=="length"||o&&(p=="offset"||p=="parent")||n&&(p=="buffer"||p=="byteLength"||p=="byteOffset")||Ee(p,l)))&&s.push(p);return s}var It=Cl;var Ol=Object.prototype;function vl(e){var t=e&&e.constructor,a=typeof t=="function"&&t.prototype||Ol;return e===a}var Ae=vl;function Nl(e,t){return function(a){return e(t(a))}}var Ct=Nl;var kl=Ct(Object.keys,Object),Er=kl;var Rl=Object.prototype,Pl=Rl.hasOwnProperty;function Ul(e){if(!Ae(e))return Er(e);var t=[];for(var a in Object(e))Pl.call(e,a)&&a!="constructor"&&t.push(a);return t}var He=Ul;function Ml(e){return e!=null&&Fe(e.length)&&!Ge(e)}var q=Ml;function Dl(e){return q(e)?It(e):He(e)}var ie=Dl;function Ll(e,t){return e&&J(t,ie(t),e)}var Sr=Ll;function Bl(e){var t=[];if(e!=null)for(var a in Object(e))t.push(a);return t}var wr=Bl;var Wl=Object.prototype,Gl=Wl.hasOwnProperty;function Kl(e){if(!I(e))return wr(e);var t=Ae(e),a=[];for(var r in e)r=="constructor"&&(t||!Gl.call(e,r))||a.push(r);return a}var Ar=Kl;function jl(e){return q(e)?It(e,!0):Ar(e)}var se=jl;function Yl(e,t){return e&&J(t,se(t),e)}var Ir=Yl;var Nr=typeof exports=="object"&&exports&&!exports.nodeType&&exports,Cr=Nr&&typeof module=="object"&&module&&!module.nodeType&&module,ql=Cr&&Cr.exports===Nr,Or=ql?M.Buffer:void 0,vr=Or?Or.allocUnsafe:void 0;function $l(e,t){if(t)return e.slice();var a=e.length,r=vr?vr(a):new e.constructor(a);return e.copy(r),r}var Ot=$l;function Fl(e,t){var a=-1,r=e.length;for(t||(t=Array(r));++a<r;)t[a]=e[a];return t}var Xe=Fl;function Hl(e,t){for(var a=-1,r=e==null?0:e.length,o=0,n=[];++a<r;){var i=e[a];t(i,a,e)&&(n[o++]=i)}return n}var kr=Hl;function Xl(){return[]}var vt=Xl;var Vl=Object.prototype,zl=Vl.propertyIsEnumerable,Rr=Object.getOwnPropertySymbols,Jl=Rr?function(e){return e==null?[]:(e=Object(e),kr(Rr(e),function(t){return zl.call(e,t)}))}:vt,Ve=Jl;function Zl(e,t){return J(e,Ve(e),t)}var Pr=Zl;function Ql(e,t){for(var a=-1,r=t.length,o=e.length;++a<r;)e[o+a]=t[a];return e}var Ie=Ql;var ep=Ct(Object.getPrototypeOf,Object),ze=ep;var tp=Object.getOwnPropertySymbols,ap=tp?function(e){for(var t=[];e;)Ie(t,Ve(e)),e=ze(e);return t}:vt,Nt=ap;function rp(e,t){return J(e,Nt(e),t)}var Ur=rp;function op(e,t,a){var r=t(e);return x(e)?r:Ie(r,a(e))}var kt=op;function np(e){return kt(e,ie,Ve)}var dt=np;function ip(e){return kt(e,se,Nt)}var Rt=ip;var sp=X(M,"DataView"),Pt=sp;var lp=X(M,"Promise"),Ut=lp;var pp=X(M,"Set"),Ce=pp;var up=X(M,"WeakMap"),Mt=up;var Mr="[object Map]",dp="[object Object]",Dr="[object Promise]",Lr="[object Set]",Br="[object WeakMap]",Wr="[object DataView]",fp=ue(Pt),cp=ue(Te),mp=ue(Ut),hp=ue(Ce),gp=ue(Mt),Me=K;(Pt&&Me(new Pt(new ArrayBuffer(1)))!=Wr||Te&&Me(new Te)!=Mr||Ut&&Me(Ut.resolve())!=Dr||Ce&&Me(new Ce)!=Lr||Mt&&Me(new Mt)!=Br)&&(Me=function(e){var t=K(e),a=t==dp?e.constructor:void 0,r=a?ue(a):"";if(r)switch(r){case fp:return Wr;case cp:return Mr;case mp:return Dr;case hp:return Lr;case gp:return Br}return t});var V=Me;var yp=Object.prototype,bp=yp.hasOwnProperty;function Tp(e){var t=e.length,a=new e.constructor(t);return t&&typeof e[0]=="string"&&bp.call(e,"index")&&(a.index=e.index,a.input=e.input),a}var Gr=Tp;var xp=M.Uint8Array,Je=xp;function _p(e){var t=new e.constructor(e.byteLength);return new Je(t).set(new Je(e)),t}var Ze=_p;function Ep(e,t){var a=t?Ze(e.buffer):e.buffer;return new e.constructor(a,e.byteOffset,e.byteLength)}var Kr=Ep;var Sp=/\w*$/;function wp(e){var t=new e.constructor(e.source,Sp.exec(e));return t.lastIndex=e.lastIndex,t}var jr=wp;var Yr=B?B.prototype:void 0,qr=Yr?Yr.valueOf:void 0;function Ap(e){return qr?Object(qr.call(e)):{}}var $r=Ap;function Ip(e,t){var a=t?Ze(e.buffer):e.buffer;return new e.constructor(a,e.byteOffset,e.length)}var Dt=Ip;var Cp="[object Boolean]",Op="[object Date]",vp="[object Map]",Np="[object Number]",kp="[object RegExp]",Rp="[object Set]",Pp="[object String]",Up="[object Symbol]",Mp="[object ArrayBuffer]",Dp="[object DataView]",Lp="[object Float32Array]",Bp="[object Float64Array]",Wp="[object Int8Array]",Gp="[object Int16Array]",Kp="[object Int32Array]",jp="[object Uint8Array]",Yp="[object Uint8ClampedArray]",qp="[object Uint16Array]",$p="[object Uint32Array]";function Fp(e,t,a){var r=e.constructor;switch(t){case Mp:return Ze(e);case Cp:case Op:return new r(+e);case Dp:return Kr(e,a);case Lp:case Bp:case Wp:case Gp:case Kp:case jp:case Yp:case qp:case $p:return Dt(e,a);case vp:return new r;case Np:case Pp:return new r(e);case kp:return jr(e);case Rp:return new r;case Up:return $r(e)}}var Fr=Fp;var Hr=Object.create,Hp=function(){function e(){}return function(t){if(!I(t))return{};if(Hr)return Hr(t);e.prototype=t;var a=new e;return e.prototype=void 0,a}}(),Xr=Hp;function Xp(e){return typeof e.constructor=="function"&&!Ae(e)?Xr(ze(e)):{}}var Lt=Xp;var Vp="[object Map]";function zp(e){return P(e)&&V(e)==Vp}var Vr=zp;var zr=fe&&fe.isMap,Jp=zr?Se(zr):Vr,Jr=Jp;var Zp="[object Set]";function Qp(e){return P(e)&&V(e)==Zp}var Zr=Qp;var Qr=fe&&fe.isSet,eu=Qr?Se(Qr):Zr,eo=eu;var tu=1,au=2,ru=4,to="[object Arguments]",ou="[object Array]",nu="[object Boolean]",iu="[object Date]",su="[object Error]",ao="[object Function]",lu="[object GeneratorFunction]",pu="[object Map]",uu="[object Number]",ro="[object Object]",du="[object RegExp]",fu="[object Set]",cu="[object String]",mu="[object Symbol]",hu="[object WeakMap]",gu="[object ArrayBuffer]",yu="[object DataView]",bu="[object Float32Array]",Tu="[object Float64Array]",xu="[object Int8Array]",_u="[object Int16Array]",Eu="[object Int32Array]",Su="[object Uint8Array]",wu="[object Uint8ClampedArray]",Au="[object Uint16Array]",Iu="[object Uint32Array]",N={};N[to]=N[ou]=N[gu]=N[yu]=N[nu]=N[iu]=N[bu]=N[Tu]=N[xu]=N[_u]=N[Eu]=N[pu]=N[uu]=N[ro]=N[du]=N[fu]=N[cu]=N[mu]=N[Su]=N[wu]=N[Au]=N[Iu]=!0;N[su]=N[ao]=N[hu]=!1;function Bt(e,t,a,r,o,n){var i,s=t&tu,l=t&au,p=t&ru;if(a&&(i=o?a(e,r,o,n):a(e)),i!==void 0)return i;if(!I(e))return e;var f=x(e);if(f){if(i=Gr(e),!s)return Xe(e,i)}else{var h=V(e),g=h==ao||h==lu;if(te(e))return Ot(e,s);if(h==ro||h==to||g&&!o){if(i=l||g?{}:Lt(e),!s)return l?Ur(e,Ir(i,e)):Pr(e,Sr(i,e))}else{if(!N[h])return o?e:{};i=Fr(e,h,s)}}n||(n=new ne);var m=n.get(e);if(m)return m;n.set(e,i),eo(e)?e.forEach(function(C){i.add(Bt(C,t,a,C,e,n))}):Jr(e)&&e.forEach(function(C,E){i.set(E,Bt(C,t,a,E,e,n))});var S=p?l?Rt:dt:l?se:ie,R=f?void 0:S(e);return At(R||e,function(C,E){R&&(E=C,C=e[E]),$e(i,E,Bt(C,t,a,E,e,n))}),i}var Wt=Bt;var Cu=1,Ou=4;function vu(e){return Wt(e,Cu|Ou)}var ae=vu;var oo=z(Be());var gx=async()=>(await new Oe().postMessage({event:"Client_checkChatGPTStatus",data:{}})).success,yx=()=>{let e=new Oe;return new Promise(t=>{let a=120,r=n=>new Promise(i=>setTimeout(i,n)),o=async()=>{let n=await e.postMessage({event:"Client_checkChatGPTStatus",data:{}});n.success&&(n?.data?.status!=="success"?(a--,a<=0&&t(!1),await r(1e3),await o()):t(!0))};o()})},Oe=class{constructor(t={}){this.runtime=t.runtime||"client"}async postMessage(t){try{return await oo.default.runtime.sendMessage({id:he,event:t.event,data:{...t.data,_RUNTIME_:this.runtime}})}catch(a){return{success:!1,message:a.message,data:{}}}}destroy(){}},bx=async()=>{let t=await new Oe({runtime:"client"}).postMessage({event:"Client_chatGetFiles",data:{}});return t.success?t.data.map(a=>{let r=ae(a);return delete r.file,r}):[]};var so=z(_t()),lo=e=>{(0,so.useEffect)(()=>{let t=()=>{e()};return window.addEventListener("focus",t),()=>{window.removeEventListener("focus",t)}},[])};var Qe=z(_t());function Nu(e){let t=(0,Qe.useRef)(),a=(0,Qe.useRef)(!1),r=(0,Qe.useRef)(!1);a.current&&(r.current=!0),(0,Qe.useEffect)(()=>{if(!a.current)return a.current=!0,t.current=e(),()=>{r.current&&t.current&&t.current()}},[])}var po=Nu;var D=z(Be());var ni=z(_t());var ii=z(no()),si=z(io());var it=z(Be());var ku="[object Symbol]";function Ru(e){return typeof e=="symbol"||P(e)&&K(e)==ku}var re=Ru;function Pu(e,t){for(var a=-1,r=e==null?0:e.length,o=Array(r);++a<r;)o[a]=t(e[a],a,e);return o}var ve=Pu;var Uu=1/0,uo=B?B.prototype:void 0,fo=uo?uo.toString:void 0;function co(e){if(typeof e=="string")return e;if(x(e))return ve(e,co)+"";if(re(e))return fo?fo.call(e):"";var t=e+"";return t=="0"&&1/e==-Uu?"-0":t}var mo=co;var Mu=/\s/;function Du(e){for(var t=e.length;t--&&Mu.test(e.charAt(t)););return t}var ho=Du;var Lu=/^\s+/;function Bu(e){return e&&e.slice(0,ho(e)+1).replace(Lu,"")}var go=Bu;var yo=0/0,Wu=/^[-+]0x[0-9a-f]+$/i,Gu=/^0b[01]+$/i,Ku=/^0o[0-7]+$/i,ju=parseInt;function Yu(e){if(typeof e=="number")return e;if(re(e))return yo;if(I(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=I(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=go(e);var a=Gu.test(e);return a||Ku.test(e)?ju(e.slice(2),a?2:8):Wu.test(e)?yo:+e}var ft=Yu;var bo=1/0,qu=17976931348623157e292;function $u(e){if(!e)return e===0?e:0;if(e=ft(e),e===bo||e===-bo){var t=e<0?-1:1;return t*qu}return e===e?e:0}var xa=$u;function Fu(e){return e}var Z=Fu;function Hu(e,t,a){switch(a.length){case 0:return e.call(t);case 1:return e.call(t,a[0]);case 2:return e.call(t,a[0],a[1]);case 3:return e.call(t,a[0],a[1],a[2])}return e.apply(t,a)}var To=Hu;function Xu(){}var xo=Xu;var Vu=800,zu=16,Ju=Date.now;function Zu(e){var t=0,a=0;return function(){var r=Ju(),o=zu-(r-a);if(a=r,o>0){if(++t>=Vu)return arguments[0]}else t=0;return e.apply(void 0,arguments)}}var _o=Zu;function Qu(e){return function(){return e}}var Eo=Qu;var ed=qe?function(e,t){return qe(e,"toString",{configurable:!0,enumerable:!1,value:Eo(t),writable:!0})}:Z,So=ed;var td=_o(So),Gt=td;function ad(e,t,a,r){for(var o=e.length,n=a+(r?1:-1);r?n--:++n<o;)if(t(e[n],n,e))return n;return-1}var wo=ad;function rd(e){return e!==e}var Ao=rd;function od(e,t,a){for(var r=a-1,o=e.length;++r<o;)if(e[r]===t)return r;return-1}var Io=od;function nd(e,t,a){return t===t?Io(e,t,a):wo(e,Ao,a)}var Co=nd;function id(e,t){var a=e==null?0:e.length;return!!a&&Co(e,t,0)>-1}var Oo=id;var vo=Math.max;function sd(e,t,a){return t=vo(t===void 0?e.length-1:t,0),function(){for(var r=arguments,o=-1,n=vo(r.length-t,0),i=Array(n);++o<n;)i[o]=r[t+o];o=-1;for(var s=Array(t+1);++o<t;)s[o]=r[o];return s[t]=a(i),To(e,this,s)}}var Kt=sd;function ld(e,t){return Gt(Kt(e,t,Z),e+"")}var jt=ld;function pd(e,t,a){if(!I(a))return!1;var r=typeof t;return(r=="number"?q(a)&&Ee(t,a.length):r=="string"&&t in a)?oe(a[t],e):!1}var De=pd;function ud(e){return jt(function(t,a){var r=-1,o=a.length,n=o>1?a[o-1]:void 0,i=o>2?a[2]:void 0;for(n=e.length>3&&typeof n=="function"?(o--,n):void 0,i&&De(a[0],a[1],i)&&(n=o<3?void 0:n,o=1),t=Object(t);++r<o;){var s=a[r];s&&e(t,s,r,n)}return t})}var Yt=ud;var dd=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,fd=/^\w*$/;function cd(e,t){if(x(e))return!1;var a=typeof e;return a=="number"||a=="symbol"||a=="boolean"||e==null||re(e)?!0:fd.test(e)||!dd.test(e)||t!=null&&e in Object(t)}var et=cd;var md="Expected a function";function _a(e,t){if(typeof e!="function"||t!=null&&typeof t!="function")throw new TypeError(md);var a=function(){var r=arguments,o=t?t.apply(this,r):r[0],n=a.cache;if(n.has(o))return n.get(o);var i=e.apply(this,r);return a.cache=n.set(o,i)||n,i};return a.cache=new(_a.Cache||Ue),a}_a.Cache=Ue;var No=_a;var hd=500;function gd(e){var t=No(e,function(r){return a.size===hd&&a.clear(),r}),a=t.cache;return t}var ko=gd;var yd=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,bd=/\\(\\)?/g,Td=ko(function(e){var t=[];return e.charCodeAt(0)===46&&t.push(""),e.replace(yd,function(a,r,o,n){t.push(o?n.replace(bd,"$1"):r||a)}),t}),Ro=Td;function xd(e){return e==null?"":mo(e)}var Po=xd;function _d(e,t){return x(e)?e:et(e,t)?[e]:Ro(Po(e))}var le=_d;var Ed=1/0;function Sd(e){if(typeof e=="string"||re(e))return e;var t=e+"";return t=="0"&&1/e==-Ed?"-0":t}var Q=Sd;function wd(e,t){t=le(t,e);for(var a=0,r=t.length;e!=null&&a<r;)e=e[Q(t[a++])];return a&&a==r?e:void 0}var Ne=wd;function Ad(e,t,a){var r=e==null?void 0:Ne(e,t);return r===void 0?a:r}var Uo=Ad;var Mo=B?B.isConcatSpreadable:void 0;function Id(e){return x(e)||ee(e)||!!(Mo&&e&&e[Mo])}var Do=Id;function Lo(e,t,a,r,o){var n=-1,i=e.length;for(a||(a=Do),o||(o=[]);++n<i;){var s=e[n];t>0&&a(s)?t>1?Lo(s,t-1,a,r,o):Ie(o,s):r||(o[o.length]=s)}return o}var tt=Lo;function Cd(e){var t=e==null?0:e.length;return t?tt(e,1):[]}var Bo=Cd;function Od(e){return Gt(Kt(e,void 0,Bo),e+"")}var Wo=Od;var vd="[object Object]",Nd=Function.prototype,kd=Object.prototype,Go=Nd.toString,Rd=kd.hasOwnProperty,Pd=Go.call(Object);function Ud(e){if(!P(e)||K(e)!=vd)return!1;var t=ze(e);if(t===null)return!0;var a=Rd.call(t,"constructor")&&t.constructor;return typeof a=="function"&&a instanceof a&&Go.call(a)==Pd}var qt=Ud;function Md(e,t,a){var r=-1,o=e.length;t<0&&(t=-t>o?0:o+t),a=a>o?o:a,a<0&&(a+=o),o=t>a?0:a-t>>>0,t>>>=0;for(var n=Array(o);++r<o;)n[r]=e[r+t];return n}var Ko=Md;var Dd="\\ud800-\\udfff",Ld="\\u0300-\\u036f",Bd="\\ufe20-\\ufe2f",Wd="\\u20d0-\\u20ff",Gd=Ld+Bd+Wd,Kd="\\ufe0e\\ufe0f",jd="\\u200d",Yd=RegExp("["+jd+Dd+Gd+Kd+"]");function qd(e){return Yd.test(e)}var jo=qd;function $d(){var e=arguments.length;if(!e)return[];for(var t=Array(e-1),a=arguments[0],r=e;r--;)t[r-1]=arguments[r];return Ie(x(a)?Xe(a):[a],tt(t,1))}var mE=$d;var Fd="__lodash_hash_undefined__";function Hd(e){return this.__data__.set(e,Fd),this}var Yo=Hd;function Xd(e){return this.__data__.has(e)}var qo=Xd;function $t(e){var t=-1,a=e==null?0:e.length;for(this.__data__=new Ue;++t<a;)this.add(e[t])}$t.prototype.add=$t.prototype.push=Yo;$t.prototype.has=qo;var Ft=$t;function Vd(e,t){for(var a=-1,r=e==null?0:e.length;++a<r;)if(t(e[a],a,e))return!0;return!1}var $o=Vd;function zd(e,t){return e.has(t)}var Ht=zd;var Jd=1,Zd=2;function Qd(e,t,a,r,o,n){var i=a&Jd,s=e.length,l=t.length;if(s!=l&&!(i&&l>s))return!1;var p=n.get(e),f=n.get(t);if(p&&f)return p==t&&f==e;var h=-1,g=!0,m=a&Zd?new Ft:void 0;for(n.set(e,t),n.set(t,e);++h<s;){var S=e[h],R=t[h];if(r)var C=i?r(R,S,h,t,e,n):r(S,R,h,e,t,n);if(C!==void 0){if(C)continue;g=!1;break}if(m){if(!$o(t,function(E,$){if(!Ht(m,$)&&(S===E||o(S,E,a,r,n)))return m.push($)})){g=!1;break}}else if(!(S===R||o(S,R,a,r,n))){g=!1;break}}return n.delete(e),n.delete(t),g}var Xt=Qd;function ef(e){var t=-1,a=Array(e.size);return e.forEach(function(r,o){a[++t]=[o,r]}),a}var Fo=ef;function tf(e){var t=-1,a=Array(e.size);return e.forEach(function(r){a[++t]=r}),a}var at=tf;var af=1,rf=2,of="[object Boolean]",nf="[object Date]",sf="[object Error]",lf="[object Map]",pf="[object Number]",uf="[object RegExp]",df="[object Set]",ff="[object String]",cf="[object Symbol]",mf="[object ArrayBuffer]",hf="[object DataView]",Ho=B?B.prototype:void 0,Ea=Ho?Ho.valueOf:void 0;function gf(e,t,a,r,o,n,i){switch(a){case hf:if(e.byteLength!=t.byteLength||e.byteOffset!=t.byteOffset)return!1;e=e.buffer,t=t.buffer;case mf:return!(e.byteLength!=t.byteLength||!n(new Je(e),new Je(t)));case of:case nf:case pf:return oe(+e,+t);case sf:return e.name==t.name&&e.message==t.message;case uf:case ff:return e==t+"";case lf:var s=Fo;case df:var l=r&af;if(s||(s=at),e.size!=t.size&&!l)return!1;var p=i.get(e);if(p)return p==t;r|=rf,i.set(e,t);var f=Xt(s(e),s(t),r,o,n,i);return i.delete(e),f;case cf:if(Ea)return Ea.call(e)==Ea.call(t)}return!1}var Xo=gf;var yf=1,bf=Object.prototype,Tf=bf.hasOwnProperty;function xf(e,t,a,r,o,n){var i=a&yf,s=dt(e),l=s.length,p=dt(t),f=p.length;if(l!=f&&!i)return!1;for(var h=l;h--;){var g=s[h];if(!(i?g in t:Tf.call(t,g)))return!1}var m=n.get(e),S=n.get(t);if(m&&S)return m==t&&S==e;var R=!0;n.set(e,t),n.set(t,e);for(var C=i;++h<l;){g=s[h];var E=e[g],$=t[g];if(r)var F=i?r($,E,g,t,e,n):r(E,$,g,e,t,n);if(!(F===void 0?E===$||o(E,$,a,r,n):F)){R=!1;break}C||(C=g=="constructor")}if(R&&!C){var W=e.constructor,j=t.constructor;W!=j&&"constructor"in e&&"constructor"in t&&!(typeof W=="function"&&W instanceof W&&typeof j=="function"&&j instanceof j)&&(R=!1)}return n.delete(e),n.delete(t),R}var Vo=xf;var _f=1,zo="[object Arguments]",Jo="[object Array]",Vt="[object Object]",Ef=Object.prototype,Zo=Ef.hasOwnProperty;function Sf(e,t,a,r,o,n){var i=x(e),s=x(t),l=i?Jo:V(e),p=s?Jo:V(t);l=l==zo?Vt:l,p=p==zo?Vt:p;var f=l==Vt,h=p==Vt,g=l==p;if(g&&te(e)){if(!te(t))return!1;i=!0,f=!1}if(g&&!f)return n||(n=new ne),i||we(e)?Xt(e,t,a,r,o,n):Xo(e,t,l,a,r,o,n);if(!(a&_f)){var m=f&&Zo.call(e,"__wrapped__"),S=h&&Zo.call(t,"__wrapped__");if(m||S){var R=m?e.value():e,C=S?t.value():t;return n||(n=new ne),o(R,C,a,r,n)}}return g?(n||(n=new ne),Vo(e,t,a,r,o,n)):!1}var Qo=Sf;function en(e,t,a,r,o){return e===t?!0:e==null||t==null||!P(e)&&!P(t)?e!==e&&t!==t:Qo(e,t,a,r,en,o)}var rt=en;var wf=1,Af=2;function If(e,t,a,r){var o=a.length,n=o,i=!r;if(e==null)return!n;for(e=Object(e);o--;){var s=a[o];if(i&&s[2]?s[1]!==e[s[0]]:!(s[0]in e))return!1}for(;++o<n;){s=a[o];var l=s[0],p=e[l],f=s[1];if(i&&s[2]){if(p===void 0&&!(l in e))return!1}else{var h=new ne;if(r)var g=r(p,f,l,e,t,h);if(!(g===void 0?rt(f,p,wf|Af,r,h):g))return!1}}return!0}var tn=If;function Cf(e){return e===e&&!I(e)}var zt=Cf;function Of(e){for(var t=ie(e),a=t.length;a--;){var r=t[a],o=e[r];t[a]=[r,o,zt(o)]}return t}var an=Of;function vf(e,t){return function(a){return a==null?!1:a[e]===t&&(t!==void 0||e in Object(a))}}var Jt=vf;function Nf(e){var t=an(e);return t.length==1&&t[0][2]?Jt(t[0][0],t[0][1]):function(a){return a===e||tn(a,e,t)}}var rn=Nf;function kf(e,t){return e!=null&&t in Object(e)}var on=kf;function Rf(e,t,a){t=le(t,e);for(var r=-1,o=t.length,n=!1;++r<o;){var i=Q(t[r]);if(!(n=e!=null&&a(e,i)))break;e=e[i]}return n||++r!=o?n:(o=e==null?0:e.length,!!o&&Fe(o)&&Ee(i,o)&&(x(e)||ee(e)))}var nn=Rf;function Pf(e,t){return e!=null&&nn(e,t,on)}var sn=Pf;var Uf=1,Mf=2;function Df(e,t){return et(e)&&zt(t)?Jt(Q(e),t):function(a){var r=Uo(a,e);return r===void 0&&r===t?sn(a,e):rt(t,r,Uf|Mf)}}var ln=Df;function Lf(e){return function(t){return t?.[e]}}var Zt=Lf;function Bf(e){return function(t){return Ne(t,e)}}var pn=Bf;function Wf(e){return et(e)?Zt(Q(e)):pn(e)}var un=Wf;function Gf(e){return typeof e=="function"?e:e==null?Z:typeof e=="object"?x(e)?ln(e[0],e[1]):rn(e):un(e)}var ot=Gf;function Kf(e,t,a,r){for(var o=-1,n=e==null?0:e.length;++o<n;){var i=e[o];t(r,i,a(i),e)}return r}var dn=Kf;function jf(e){return function(t,a,r){for(var o=-1,n=Object(t),i=r(t),s=i.length;s--;){var l=i[e?s:++o];if(a(n[l],l,n)===!1)break}return t}}var fn=jf;var Yf=fn(),Qt=Yf;function qf(e,t){return e&&Qt(e,t,ie)}var cn=qf;function $f(e,t){return function(a,r){if(a==null)return a;if(!q(a))return e(a,r);for(var o=a.length,n=t?o:-1,i=Object(a);(t?n--:++n<o)&&r(i[n],n,i)!==!1;);return a}}var mn=$f;var Ff=mn(cn),nt=Ff;function Hf(e,t,a,r){return nt(e,function(o,n,i){t(r,o,a(o),i)}),r}var hn=Hf;function Xf(e,t){return function(a,r){var o=x(a)?dn:hn,n=t?t():{};return o(a,e,ot(r,2),n)}}var gn=Xf;var Vf=function(){return M.Date.now()},ea=Vf;var zf="Expected a function",Jf=Math.max,Zf=Math.min;function Qf(e,t,a){var r,o,n,i,s,l,p=0,f=!1,h=!1,g=!0;if(typeof e!="function")throw new TypeError(zf);t=ft(t)||0,I(a)&&(f=!!a.leading,h="maxWait"in a,n=h?Jf(ft(a.maxWait)||0,t):n,g="trailing"in a?!!a.trailing:g);function m(v){var A=r,w=o;return r=o=void 0,p=v,i=e.apply(w,A),i}function S(v){return p=v,s=setTimeout(E,t),f?m(v):i}function R(v){var A=v-l,w=v-p,ke=t-A;return h?Zf(ke,n-w):ke}function C(v){var A=v-l,w=v-p;return l===void 0||A>=t||A<0||h&&w>=n}function E(){var v=ea();if(C(v))return $(v);s=setTimeout(E,R(v))}function $(v){return s=void 0,g&&r?m(v):(r=o=void 0,i)}function F(){s!==void 0&&clearTimeout(s),p=0,r=l=o=s=void 0}function W(){return s===void 0?i:$(ea())}function j(){var v=ea(),A=C(v);if(r=arguments,o=this,l=v,A){if(s===void 0)return S(l);if(h)return clearTimeout(s),s=setTimeout(E,t),m(l)}return s===void 0&&(s=setTimeout(E,t)),i}return j.cancel=F,j.flush=W,j}var yn=Qf;function ec(e,t,a){(a!==void 0&&!oe(e[t],a)||a===void 0&&!(t in e))&&_e(e,t,a)}var ct=ec;function tc(e){return P(e)&&q(e)}var bn=tc;function ac(e,t){if(!(t==="constructor"&&typeof e[t]=="function")&&t!="__proto__")return e[t]}var mt=ac;function rc(e){return J(e,se(e))}var Tn=rc;function oc(e,t,a,r,o,n,i){var s=mt(e,a),l=mt(t,a),p=i.get(l);if(p){ct(e,a,p);return}var f=n?n(s,l,a+"",e,t,i):void 0,h=f===void 0;if(h){var g=x(l),m=!g&&te(l),S=!g&&!m&&we(l);f=l,g||m||S?x(s)?f=s:bn(s)?f=Xe(s):m?(h=!1,f=Ot(l,!0)):S?(h=!1,f=Dt(l,!0)):f=[]:qt(l)||ee(l)?(f=s,ee(s)?f=Tn(s):(!I(s)||Ge(s))&&(f=Lt(l))):h=!1}h&&(i.set(l,f),o(f,l,r,n,i),i.delete(l)),ct(e,a,f)}var xn=oc;function _n(e,t,a,r,o){e!==t&&Qt(t,function(n,i){if(o||(o=new ne),I(n))xn(e,t,i,a,_n,r,o);else{var s=r?r(mt(e,i),n,i+"",e,t,o):void 0;s===void 0&&(s=n),ct(e,i,s)}},se)}var ta=_n;var nc=Yt(function(e,t,a,r){ta(e,t,a,r)}),Sa=nc;function ic(e,t,a){for(var r=-1,o=e==null?0:e.length;++r<o;)if(a(t,e[r]))return!0;return!1}var En=ic;function sc(e){var t=e==null?0:e.length;return t?e[t-1]:void 0}var Sn=sc;function lc(e){return typeof e=="function"?e:Z}var wn=lc;function pc(e,t){var a=x(e)?At:nt;return a(e,wn(t))}var nA=pc;function uc(e,t){var a=-1,r=q(e)?Array(e.length):[];return nt(e,function(o,n,i){r[++a]=t(o,n,i)}),r}var An=uc;var dc=Object.prototype,fc=dc.hasOwnProperty,cc=gn(function(e,t,a){fc.call(e,a)?e[a].push(t):_e(e,a,[t])}),fA=cc;var mc="[object String]";function hc(e){return typeof e=="string"||!x(e)&&P(e)&&K(e)==mc}var In=hc;function gc(e,t){return t.length<2?e:Ne(e,Ko(t,0,-1))}var Cn=gc;var yc="[object Map]",bc="[object Set]",Tc=Object.prototype,xc=Tc.hasOwnProperty;function _c(e){if(e==null)return!0;if(q(e)&&(x(e)||typeof e=="string"||typeof e.splice=="function"||te(e)||we(e)||ee(e)))return!e.length;var t=V(e);if(t==yc||t==bc)return!e.size;if(Ae(e))return!He(e).length;for(var a in e)if(xc.call(e,a))return!1;return!0}var vA=_c;function Ec(e,t){return rt(e,t)}var Sc=Ec;var wc="[object Number]";function Ac(e){return typeof e=="number"||P(e)&&K(e)==wc}var MA=Ac;function Ic(e,t){for(var a,r=-1,o=e.length;++r<o;){var n=t(e[r]);n!==void 0&&(a=a===void 0?n:a+n)}return a}var On=Ic;var Cc=Yt(function(e,t,a){ta(e,t,a)}),GA=Cc;function Oc(e,t){return t=le(t,e),e=Cn(e,t),e==null||delete e[Q(Sn(t))]}var vn=Oc;function vc(e){return qt(e)?void 0:e}var Nn=vc;var Nc=1,kc=2,Rc=4,Pc=Wo(function(e,t){var a={};if(e==null)return a;var r=!1;t=ve(t,function(n){return n=le(n,e),r||(r=n.length>1),n}),J(e,Rt(e),a),r&&(a=Wt(a,Nc|kc|Rc,Nn));for(var o=t.length;o--;)vn(a,t[o]);return a}),rI=Pc;function Uc(e,t,a,r){if(!I(e))return e;t=le(t,e);for(var o=-1,n=t.length,i=n-1,s=e;s!=null&&++o<n;){var l=Q(t[o]),p=a;if(l==="__proto__"||l==="constructor"||l==="prototype")return e;if(o!=i){var f=s[l];p=r?r(f,l,s):void 0,p===void 0&&(p=I(f)?f:Ee(t[o+1])?[]:{})}$e(s,l,p),s=s[l]}return e}var kn=Uc;function Mc(e,t){var a=e.length;for(e.sort(t);a--;)e[a]=e[a].value;return e}var Rn=Mc;function Dc(e,t){if(e!==t){var a=e!==void 0,r=e===null,o=e===e,n=re(e),i=t!==void 0,s=t===null,l=t===t,p=re(t);if(!s&&!p&&!n&&e>t||n&&i&&l&&!s&&!p||r&&i&&l||!a&&l||!o)return 1;if(!r&&!n&&!p&&e<t||p&&a&&o&&!r&&!n||s&&a&&o||!i&&o||!l)return-1}return 0}var Pn=Dc;function Lc(e,t,a){for(var r=-1,o=e.criteria,n=t.criteria,i=o.length,s=a.length;++r<i;){var l=Pn(o[r],n[r]);if(l){if(r>=s)return l;var p=a[r];return l*(p=="desc"?-1:1)}}return e.index-t.index}var Un=Lc;function Bc(e,t,a){t.length?t=ve(t,function(n){return x(n)?function(i){return Ne(i,n.length===1?n[0]:n)}:n}):t=[Z];var r=-1;t=ve(t,Se(ot));var o=An(e,function(n,i,s){var l=ve(t,function(p){return p(n)});return{criteria:l,index:++r,value:n}});return Rn(o,function(n,i){return Un(n,i,a)})}var aa=Bc;function Wc(e,t,a,r){return e==null?[]:(x(t)||(t=t==null?[]:[t]),a=r?void 0:a,x(a)||(a=a==null?[]:[a]),aa(e,t,a))}var wa=Wc;var Gc=Zt("length"),Mn=Gc;var Ln="\\ud800-\\udfff",Kc="\\u0300-\\u036f",jc="\\ufe20-\\ufe2f",Yc="\\u20d0-\\u20ff",qc=Kc+jc+Yc,$c="\\ufe0e\\ufe0f",Fc="["+Ln+"]",Aa="["+qc+"]",Ia="\\ud83c[\\udffb-\\udfff]",Hc="(?:"+Aa+"|"+Ia+")",Bn="[^"+Ln+"]",Wn="(?:\\ud83c[\\udde6-\\uddff]){2}",Gn="[\\ud800-\\udbff][\\udc00-\\udfff]",Xc="\\u200d",Kn=Hc+"?",jn="["+$c+"]?",Vc="(?:"+Xc+"(?:"+[Bn,Wn,Gn].join("|")+")"+jn+Kn+")*",zc=jn+Kn+Vc,Jc="(?:"+[Bn+Aa+"?",Aa,Wn,Gn,Fc].join("|")+")",Dn=RegExp(Ia+"(?="+Ia+")|"+Jc+zc,"g");function Zc(e){for(var t=Dn.lastIndex=0;Dn.test(e);)++t;return t}var Yn=Zc;function Qc(e){return jo(e)?Yn(e):Mn(e)}var qn=Qc;var em=Math.floor,tm=Math.random;function am(e,t){return e+em(tm()*(t-e+1))}var $n=am;var rm=parseFloat,om=Math.min,nm=Math.random;function im(e,t,a){if(a&&typeof a!="boolean"&&De(e,t,a)&&(t=a=void 0),a===void 0&&(typeof t=="boolean"?(a=t,t=void 0):typeof e=="boolean"&&(a=e,e=void 0)),e===void 0&&t===void 0?(e=0,t=1):(e=xa(e),t===void 0?(t=e,e=0):t=xa(t)),e>t){var r=e;e=t,t=r}if(a||e%1||t%1){var o=nm();return om(e+o*(t-e+rm("1e-"+((o+"").length-1))),t)}return $n(e,t)}var GI=im;var sm=Array.prototype,lm=sm.reverse;function pm(e){return e==null?e:lm.call(e)}var jI=pm;function um(e,t,a){return e==null?e:kn(e,t,a)}var Fn=um;var dm="[object Map]",fm="[object Set]";function cm(e){if(e==null)return 0;if(q(e))return In(e)?qn(e):e.length;var t=V(e);return t==dm||t==fm?e.size:He(e).length}var JI=cm;var mm=jt(function(e,t){if(e==null)return[];var a=t.length;return a>1&&De(e,t[0],t[1])?t=[]:a>2&&De(t[0],t[1],t[2])&&(t=[t[0]]),aa(e,tt(t,1),[])}),hm=mm;function gm(e){return e&&e.length?On(e,Z):0}var iC=gm;var ym="Expected a function";function bm(e,t,a){var r=!0,o=!0;if(typeof e!="function")throw new TypeError(ym);return I(a)&&(r="leading"in a?!!a.leading:r,o="trailing"in a?!!a.trailing:o),yn(e,t,{leading:r,maxWait:t,trailing:o})}var Tm=bm;var xm=1/0,_m=Ce&&1/at(new Ce([,-0]))[1]==xm?function(e){return new Ce(e)}:xo,Hn=_m;var Em=200;function Sm(e,t,a){var r=-1,o=Oo,n=e.length,i=!0,s=[],l=s;if(a)i=!1,o=En;else if(n>=Em){var p=t?null:Hn(e);if(p)return at(p);i=!1,o=Ht,l=new Ft}else l=t?[]:s;e:for(;++r<n;){var f=e[r],h=t?t(f):f;if(f=a||f!==0?f:0,i&&h===h){for(var g=l.length;g--;)if(l[g]===h)continue e;t&&l.push(h),s.push(f)}else o(l,h,a)||(l!==s&&l.push(h),s.push(f))}return s}var ra=Sm;function wm(e){return e&&e.length?ra(e):[]}var SC=wm;function Am(e,t){return e&&e.length?ra(e,ot(t,2)):[]}var Xn=Am;var Vn=[{id:"c769f823-a073-408a-ac44-00e5bfc333a7",parent:"b83cb482-710d-4e48-9b22-43b8e8ea3a02",droppable:!0,text:"Quick reply",data:{editable:!1,type:"group",actions:[],visibility:{whitelist:[],blacklist:[],isWhitelistMode:!1},icon:"Reply",searchText:"messaging quick reply"}},{id:"0607ffb9-e0fb-41b5-9e02-afabff22acb6",parent:"c769f823-a073-408a-ac44-00e5bfc333a7",droppable:!0,text:"Like",data:{editable:!1,type:"shortcuts",actions:[{type:"RENDER_TEMPLATE",parameters:{template:`Ignore all previous instructions. You're a highly skilled messaging expert, adept at responding to all types of chat messages and posts in an appropriate manner. Your task is to write a reply to the following text delimited by triple backticks, which is a chat message on {{CURRENT_WEBSITE_DOMAIN}}.
...
{{KEY_POINTS}}`,variables:[{label:"Context",VariableName:"CONTEXT",valueType:"Text",placeholder:"Enter context",defaultValue:"{{SELECTED_TEXT}}"},{label:"Key points",VariableName:"KEY_POINTS",valueType:"Text",placeholder:"Enter key points"}],systemVariables:[{VariableName:"AI_RESPONSE_LANGUAGE",defaultValue:"English",valueType:"Select",systemVariable:!0},{VariableName:"AI_RESPONSE_TONE",defaultValue:"Default",valueType:"Select",systemVariable:!0},{VariableName:"AI_RESPONSE_WRITING_STYLE",defaultValue:"Default",valueType:"Select",systemVariable:!0}]}}}],visibility:{whitelist:[],blacklist:[],isWhitelistMode:!1},searchText:"quick reply reply with key points"}},{id:"a261c7e0-1a4f-485f-a9e0-9998c45cd08c",parent:"665d4c2f-0f17-43be-9a49-a65ace4ef4e7",droppable:!0,text:"Yes",data:{editable:!1,type:"shortcuts",actions:[{type:"RENDER_TEMPLATE",parameters:{template:`Ignore all previous instructions. You're a highly skilled email expert, adept at responding to all types of email messages in an appropriate manner. Your task is to write a reply to the following text delimited by triple backticks, which is an email message on {{CURRENT_WEBSITE_DOMAIN}}.
